...
label9:
  ...
  leave
  ret
# Class bar___________________________________________________________
  # 
  .section .text
# __Method bar.bar____________________________________________________
  .globl bar_bar
bar_bar:
  # Variable     Offset
...
label12:
  ...
  leave
  ret
# Class foo___________________________________________________________
  # 
  .section .text
# __Method foo.foo____________________________________________________
  .globl foo_foo
foo_foo:
  # Variable     Offset
  # foo          -12
...
label15:
  ...
  ret
  .section .text
# __Method foo.bar____________________________________________________
  .globl foo_bar
foo_bar:
  # Variable     Offset
  # implicit=8 localSlot=12 sum=20
