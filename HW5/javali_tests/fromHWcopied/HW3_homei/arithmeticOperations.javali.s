...
label7:
    ...
    add $4, %esp
    movl %edi, 16(%esi)
    # Emitting this.res = ((-(this.a) + +(this.b)) - ((this.c * this.a) % (this.b / 1)))
      # Emitting ((-(this.a) + +(this.b)) - ((this.c * this.a) % (this.b / 1)))
        # Emitting (-(this.a) + +(this.b))
          # Emitting -(this.a)
            # Emitting this.a
              # Emitting this
              movl 8(%ebp), %edi
          ...
          # Emitting +(this.b)
            ...
            movl 12(%esi), %esi
        addl %esi, %edi
        # Emitting ((this.c * this.a) % (this.b / 1))
          # Emitting (this.c * this.a)
            # Emitting this.c
              # Emitting this
              movl 8(%ebp), %esi
            push %esi
