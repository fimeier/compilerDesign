...
label9:
  ...
  ret
  .section .text
# __Method Main.foo1__________________________________________________
  .globl Main_foo1
Main_foo1:
  # Variable     Offset
  # s            -12
...
label12:
  ...
  ret
  .section .text
# __Method Main.foo2__________________________________________________
  .globl Main_foo2
Main_foo2:
  # Variable     Offset
  # s            -12
...
label15:
  ...
  ret
  .section .text
# __Method Main.foo3__________________________________________________
  .globl Main_foo3
Main_foo3:
  # Variable     Offset
  # implicit=8 localSlot=12 sum=20
...
label18:
  ...
  ret
  .section .text
# __Method Main.foo4__________________________________________________
  .globl Main_foo4
Main_foo4:
  # Variable     Offset
  # implicit=8 localSlot=12 sum=20
