...
# Class A_____________________________________________________________
  # 
  .section .text
# __Method A.fun1_____________________________________________________
  .globl A_fun1
A_fun1:
  # Variable     Offset
  # implicit=8 localSlot=12 sum=20
...
label12:
  ...
  leave
  ret
# Class S_____________________________________________________________
  # 
  .section .text
# __Method S.fun1_____________________________________________________
  .globl S_fun1
S_fun1:
  # Variable     Offset
  # implicit=8 localSlot=12 sum=20
